						...
						<tbody>
							<c:forEach var="u" items="${dsHoaDon}">
								<tr>
									...
									<td><a href="admin/hoadon/chitiethoadon/${u.maHoaDon}.htm"><button
												class="ui pink basic button">Xem Chi Tiết</button></a></td>
									<td><a href="admin/hoadon/update/${u.maHoaDon}.htm"><button
												class="ui green basic button">Sửa</button></a></td>
									<td><a href="admin/hoadon/delete/${u.maHoaDon}.htm"><button
												class="ui red basic button">Xóa</button></a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
					<a href="admin/hoadon/insert.htm"><div class="ui button">Thêm</div></a>
					${message}				
				</div>
			</div>
		</div>
