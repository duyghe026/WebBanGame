	...
	<div class="pusher">
		<div class="main-content">
			<div class="ui grid stackable padded">
				<div class="column">
					<form:form class="ui form" action="admin/hoadon/insert.htm"
						modelAttribute="hoaDon">
						<div class="field">
							<label>Ngày Bán</label>
							<form:input path="ngayBan" type="date" required="required"/>
							<div style="color: red">
								<form:errors path="ngayBan" />
							</div>
						</div>
						<div class="field">
							<label>Mã Khách Hàng</label>
							<form:select path="user.iDUser" items="${dsUser}"
								itemValue="iDUser" itemLabel="userName" />
							<div style="color: red">
								<form:errors path="user.iDUser" />
							</div>
						</div>
						<div class="field">
							<div class="ui toggle checkbox">
								<form:checkbox path="tinhTrang" selected="true" />
								<label>Thanh Toán</label>
							</div>
						</div>
						<div>
							<button class="ui button">Thêm</button>
							<a href="admin/hoadon/index.htm"><div class="ui button">Trở
									Lại</div></a> ${message}
						</div>
					</form:form>
				</div>
