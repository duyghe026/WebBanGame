					...
					<form class="ui form" action="admin/hanghoa/update.htm"
						...
						<div class="ui two column centered grid">
							<div class="column">
								...
								<form:input type="text" path="hangHoa.maHangHoa" readonly="true"/>
							</div>
							<div class="column">
							...
							<div class="column">
								<label>Đơn Giá</label>
								<form:input type="number" path="hangHoa.donGia" min="1000" />
							</div>
							<div class="column">
								<label>Giảm Giá</label>
								<form:input type="number" path="hangHoa.giamGia" min="0" />
								<div style="color: red">
